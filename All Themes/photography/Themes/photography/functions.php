 ...
 */ 
    ...
    function photography_setup()
    {
        ...
        register_nav_menus(array(
            'top-nav' => esc_html__('Top Nav', 'photography')
        ));
...
function photography_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => esc_html__('Logo & Address', 'photography'),
        'id' => 'footer-1',
        'description' => esc_html__('Appears in the footer area', 'photography'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Social Icons & Email', 'photography'),
        'id' => 'footer-2',
        'description' => esc_html__('Appears in the footer area', 'photography'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Top-Bar-Left', 'photography'),
        'id' => 'top-bar',
        'description' => esc_html__('Appears in the Top-Bar', 'photography'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3 class="widget-title">',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 1', 'photography'),
        'id' => 'shop-footer-1',
        'description' => esc_html__('Appears in the footer area', 'photography'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 2', 'photography'),
        'id' => 'shop-footer-2',
        'description' => esc_html__('Appears in the footer area', 'photography'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 3', 'photography'),
        'id' => 'shop-footer-3',
        'description' => esc_html__('Appears in the footer area', 'photography'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 4', 'photography'),
        'id' => 'shop-footer-4',
        'description' => esc_html__('Appears in the footer area', 'photography'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Shop Sidebar', 'photography'),
        'id' => 'shop-sidebar',
        'description' => esc_html__('Add widgets here.', 'photography'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Theme Feature', 'photography'),
        'id' => 'theme-feature',
        'description' => esc_html__('Add widgets here.', 'photography'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
...
function photography_google_fonts_url() {
    $font_url = '';

    if ( 'off' !== _x( 'on', 'Google font: on or off', 'photography' ) ) {
...
function photography_scripts()
{
    ...
    /* Theme CSS */
    wp_enqueue_style('photography-default-theme-style', get_template_directory_uri() . '/css/default-theme-style.css');
    wp_enqueue_style('google-fonts-family', photography_google_fonts_url(), array(), '1.0.0' );
	wp_enqueue_style('flaticon', get_template_directory_uri() . '/css/flaticon.css');
    wp_enqueue_style('photography-style', get_template_directory_uri() . '/css/style.css');
    wp_enqueue_style('photography-custom', get_template_directory_uri() . '/css/custom.css');
    ...
    if(get_the_ID() == 1825){
    wp_enqueue_style('photography-custom-base', get_template_directory_uri() . '/css/custom-base.css');
    }
    /* Default CSS */
    ...
    //photography css
    wp_enqueue_style( 'photography-default-at', get_template_directory_uri() . '/css/default-at-style.css');
    //wp_enqueue_style('photography-stylesheet', 'http://multipurposethemes.com/wordpressdemo/photography/wp-content/themes/photography/style.css');
    wp_enqueue_style('photography-stylesheet', get_template_directory_uri() . '/css/photography-style.css');

    // Add Multipurpose js
   //wp_enqueue_script( 'photography-customjs', get_stylesheet_directory_uri() . '/js/multipurpose.js');
    ...
    //navigation js
    wp_enqueue_script( 'photography-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '1.0', true );    
    ...
    wp_enqueue_script('photography-scrollreveal', get_template_directory_uri() . '/vendor/scrollreveal/scrollreveal.min.js', array(), '', true);
    
    /* Theme JavaScript */
    wp_enqueue_script('photography-theme', get_template_directory_uri() . '/js/theme.js', array(), '', true);
...
function photography_scripts_footer()
{
    wp_enqueue_script('photography-js');
}
add_action('wp_footer', 'photography_scripts_footer');


/* Theme Options 

function photography_add_theme_menu_item()
{
    add_theme_page("Theme Options", "Theme Options", "manage_options", "theme-panel", "photography_theme_settings_page", null, 99);
}

add_action("admin_menu", "photography_add_theme_menu_item");
...
function photography_logo_display()
{
?>
...
function photography_handle_logo_upload()
{
...
function photography_change_font()
{
    $load_fonts = photography_google_fonts();
...
function photography_theme_panel_fields()
{
    add_settings_section("section", "All Settings", null, "theme-options");
    
    add_settings_field("change_font", "Google Font Family", "photography_change_font", "theme-options", "section");
    add_settings_field("logo", "Top Menu Logo", "photography_logo_display", "theme-options", "section");
    
    register_setting("section", "change_font");
    register_setting("section", "logo", "photography_handle_logo_upload");
}

add_action("admin_init", "photography_theme_panel_fields");
...
if (!function_exists('photography_get_google_fonts')):
    function photography_get_google_fonts()
    {
...
add_action('wp_enqueue_scripts', 'photography_get_google_fonts');
...
function photography_theme_options(){
    ...
    /* Custom CSS */
	//wp_enqueue_style('photography-custom-style', get_template_directory_uri() . '/css/custom.css');
    wp_add_inline_style('photography-custom-style', $custom_css);
    
}
add_action('wp_enqueue_scripts', 'photography_theme_options');
        ...
        if ( class_exists( 'woocommerce' ) ) {
            ...
            $items .= '<li class="' . esc_attr( $css_class ) . '">';
                $items .= '<a class="cart-contents" href="' . esc_url( WC()->cart->get_cart_url() ) . '"><i class="fa fa-shopping-bag" aria-hidden="true"></i> ';
                    $items .= wp_kses_data( WC()->cart->get_cart_total() ) . ' - <span class="count">' .  wp_kses_data( sprintf( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'photography' ), WC()->cart->get_cart_contents_count() ) ) . '</span>';
                $items .= '</a>';
            $items .= '</li>';
        }
        // Easy Digital Downloads
            ...
            $items .= '<li class="' . esc_attr( $css_class ) . '">';
                $items .= '<a class="cart-contents" href="' . esc_url( edd_get_checkout_uri() ) . '"><i class="fa fa-shopping-bag" aria-hidden="true"></i> ';
                    $items .= wp_kses_data( edd_cart_subtotal() ) . ' - <span class="count">' .  wp_kses_data( sprintf( _n( '%d item', '%d items', edd_get_cart_quantity(), 'photography' ), edd_get_cart_quantity() ) ) . '</span>';
                $items .= '</a>';
            $items .= '</li>';
        }
    }
...
function photography_custom_excerpt_more($more) {
      global $post;
      if ($post->post_type == 'post'){
   ...
   add_filter('excerpt_more', 'photography_custom_excerpt_more');
/*animated number counter script*/



/* +========================ot_theme_mode  Added By Dev8 on 15/09/2017===========================================*/
function photography_theme_file() {

	require_once( get_template_directory() . '/inc/photography-theme-option.php' );

}
add_action('wp_head', 'photography_theme_file');
/**
...
function ocdi_import_files() {
  return array(
    array(
      ...
      'import_file_url'            => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/photography/demo-content.xml',
      'import_widget_file_url'     => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/photography/widgets.wie',
      'import_customizer_file_url' => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/photography/customizer.dat',
      'import_preview_image_url'   => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/photography/screenshot.png',
      'import_notice'              => __( 'After you import this demo, you will have to setup the slider separately.', 'maximum' ),
      'preview_url'                => 'http://creativewordpressthemes.multipurposethemes.com/photography/',
    ),
  );
}
