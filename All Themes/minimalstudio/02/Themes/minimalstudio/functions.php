...
function ocdi_import_files() {
  return array(
    array(
      ...
      'import_file_url'            => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/minimalstudio/02/demo-content.xml',
      'import_widget_file_url'     => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/minimalstudio/02/widgets.wie',
      'import_customizer_file_url' => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/minimalstudio/02/customizer.dat',
      'import_preview_image_url'   => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/minimalstudio/02/screenshot.png',
      'import_notice'              => __( 'After you import this demo, you will have to setup the slider separately.', 'minimal' ),
      'preview_url'                => 'https://www.multipurposethemes.com/wordpressdemo/minimalstudio/02/',
    ),
  );
}
