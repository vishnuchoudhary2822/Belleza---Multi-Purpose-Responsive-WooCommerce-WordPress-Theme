...
if ( ! class_exists( 'OT_Meta_Box' ) ) {
  ...
  class OT_Meta_Box {
    ...
    function __construct( $meta_box ) {
      ...
      add_action( 'add_meta', array( $this, 'add_meta' ) );
    ...
    function add_meta() {
      foreach ( (array) $this->meta_box['pages'] as $page ) {
        add_meta( $this->meta_box['id'], $this->meta_box['title'], array( $this, 'build_meta_box' ), $page, $this->meta_box['context'], $this->meta_box['priority'], $this->meta_box['fields'] );
      }
    }
