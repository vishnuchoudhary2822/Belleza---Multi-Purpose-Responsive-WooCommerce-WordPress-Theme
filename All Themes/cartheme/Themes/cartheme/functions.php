<?php
/**
 * cartheme functions and definitions
 *
 ...
 */ 
    ...
    function cartheme_setup()
    {
         ...
         * If you're building a theme based on cartheme, use a find and replace
         * to change 'cartheme' to the name of your theme in all the template files.
         */
        load_theme_textdomain('cartheme', get_template_directory() . '/languages');
        ...
        register_nav_menus(array(
            'menu-1' => esc_html__('Primary', 'cartheme')
        ));

        register_nav_menus(array(
            'top-nav' => esc_html__('Top Nav', 'cartheme')
        ));
        ...
        add_theme_support('custom-background', apply_filters('cartheme_custom_background_args', array(
 ...
 */
function cartheme_content_width()
{
    $GLOBALS['content_width'] = apply_filters('cartheme_content_width', 640);
}
add_action('after_setup_theme', 'cartheme_content_width', 0);
...
function cartheme_widgets_init()
{
    register_sidebar(array(
        'name' => esc_html__('Sidebar', 'cartheme'),
        'id' => 'sidebar-1',
        'description' => esc_html__('Add widgets here.', 'cartheme'),
    ...
    register_sidebar(array(
        'name' => esc_html__('Logo & Address', 'cartheme'),
        'id' => 'footer-1',
        'description' => esc_html__('Appears in the footer area', 'cartheme'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Social Icons & Email', 'cartheme'),
        'id' => 'footer-2',
        'description' => esc_html__('Appears in the footer area', 'cartheme'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Top-Bar-Left', 'cartheme'),
        'id' => 'top-bar',
        'description' => esc_html__('Appears in the Top-Bar', 'cartheme'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3 class="widget-title">',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 1', 'cartheme'),
        'id' => 'shop-footer-1',
        'description' => esc_html__('Appears in the footer area', 'cartheme'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 2', 'cartheme'),
        'id' => 'shop-footer-2',
        'description' => esc_html__('Appears in the footer area', 'cartheme'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 3', 'cartheme'),
        'id' => 'shop-footer-3',
        'description' => esc_html__('Appears in the footer area', 'cartheme'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 4', 'cartheme'),
        'id' => 'shop-footer-4',
        'description' => esc_html__('Appears in the footer area', 'cartheme'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Shop Sidebar', 'cartheme'),
        'id' => 'shop-sidebar',
        'description' => esc_html__('Add widgets here.', 'cartheme'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
    ...
    register_sidebar(array(
        'name' => esc_html__('Theme Feature', 'cartheme'),
        'id' => 'theme-feature',
        'description' => esc_html__('Add widgets here.', 'cartheme'),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget' => '</section>',
...
function cartheme_google_fonts_url() {
    $font_url = '';

    if ( 'off' !== _x( 'on', 'Google font: on or off', 'cartheme' ) ) {
...
function cartheme_scripts()
{
    ...
    /* Theme CSS */
    wp_enqueue_style('cartheme-default-theme-style', get_template_directory_uri() . '/css/default-theme-style.css');
    wp_enqueue_style('google-fonts-family', cartheme_google_fonts_url(), array(), '1.0.0' );
	wp_enqueue_style('flaticon', get_template_directory_uri() . '/css/flaticon.css');
    wp_enqueue_style('cartheme-style', get_template_directory_uri() . '/css/style.css');
    wp_enqueue_style('cartheme-custom', get_template_directory_uri() . '/css/custom.css');
    ...
    if(get_the_ID() == 1825){
    wp_enqueue_style('cartheme-custom-base', get_template_directory_uri() . '/css/custom-base.css');
    }
    /* Default CSS */
    ...
    //cartheme css
    wp_enqueue_style( 'cartheme-default-at', get_template_directory_uri() . '/css/default-at-style.css');
    //wp_enqueue_style('cartheme-stylesheet', 'http://multipurposethemes.com/wordpressdemo/cartheme/wp-content/themes/cartheme/style.css');
    wp_enqueue_style('cartheme-stylesheet', get_template_directory_uri() . '/css/cartheme-style.css');

    //navigation js
   wp_enqueue_script( 'cartheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '1.0', true );

    // Add Multipurpose js
   //wp_enqueue_script( 'cartheme-customjs', get_stylesheet_directory_uri() . '/js/multipurpose.js');
    ...
    wp_enqueue_script('cartheme-scrollreveal', get_template_directory_uri() . '/vendor/scrollreveal/scrollreveal.min.js', array(), '', true);
    
    /* Theme JavaScript */
    wp_enqueue_script('cartheme-theme', get_template_directory_uri() . '/js/theme.js', array(), '', true);
...
function cartheme_scripts_footer()
{
    wp_enqueue_script('cartheme-js');
}
add_action('wp_footer', 'cartheme_scripts_footer');


/* Theme Options 

function cartheme_add_theme_menu_item()
{
    add_theme_page("Theme Options", "Theme Options", "manage_options", "theme-panel", "cartheme_theme_settings_page", null, 99);
}

add_action("admin_menu", "cartheme_add_theme_menu_item");

function cartheme_theme_settings_page()
{
?>
       <div class="wrap">
        <h1>Theme Panel</h1>
...
function cartheme_logo_display()
{
?>
...
function cartheme_handle_logo_upload()
{
...
function cartheme_change_font()
{
    $load_fonts = cartheme_google_fonts();
...
function cartheme_theme_panel_fields()
{
    add_settings_section("section", "All Settings", null, "theme-options");
    
    add_settings_field("change_font", "Google Font Family", "cartheme_change_font", "theme-options", "section");
    add_settings_field("logo", "Top Menu Logo", "cartheme_logo_display", "theme-options", "section");
    
    register_setting("section", "change_font");
    register_setting("section", "logo", "cartheme_handle_logo_upload");
}

add_action("admin_init", "cartheme_theme_panel_fields");
...
if (!function_exists('cartheme_get_google_fonts')):
    function cartheme_get_google_fonts()
    {
...
add_action('wp_enqueue_scripts', 'cartheme_get_google_fonts');

function cartheme_theme_options(){
    $custom_css        = "";
    $theme_font_family = (get_option('change_font') != '') ? get_option('change_font') : '';
    ...
    /* Custom CSS */
	//wp_enqueue_style('cartheme-custom-style', get_template_directory_uri() . '/css/custom.css');
    wp_add_inline_style('cartheme-custom-style', $custom_css);
    
}
add_action('wp_enqueue_scripts', 'cartheme_theme_options');
        ...
        if ( class_exists( 'woocommerce' ) ) {
            ...
            $items .= '<li class="' . esc_attr( $css_class ) . '">';
                $items .= '<a class="cart-contents" href="' . esc_url( WC()->cart->get_cart_url() ) . '"><i class="fa fa-shopping-bag" aria-hidden="true"></i> ';
                    $items .= wp_kses_data( WC()->cart->get_cart_total() ) . ' - <span class="count">' .  wp_kses_data( sprintf( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'cartheme' ), WC()->cart->get_cart_contents_count() ) ) . '</span>';
                $items .= '</a>';
            $items .= '</li>';
        }
        // Easy Digital Downloads
            ...
            $items .= '<li class="' . esc_attr( $css_class ) . '">';
                $items .= '<a class="cart-contents" href="' . esc_url( edd_get_checkout_uri() ) . '"><i class="fa fa-shopping-bag" aria-hidden="true"></i> ';
                    $items .= wp_kses_data( edd_cart_subtotal() ) . ' - <span class="count">' .  wp_kses_data( sprintf( _n( '%d item', '%d items', edd_get_cart_quantity(), 'cartheme' ), edd_get_cart_quantity() ) ) . '</span>';
                $items .= '</a>';
            $items .= '</li>';
        }
    }
...
function cartheme_custom_excerpt_more($more) {
      global $post;
      if ($post->post_type == 'post'){
   ...
   add_filter('excerpt_more', 'cartheme_custom_excerpt_more');
/*animated number counter script*/



/* +========================ot_theme_mode  Added By Dev8 on 15/09/2017===========================================*/
function cartheme_theme_file() {

	require_once( get_template_directory() . '/inc/cartheme-theme-option.php' );

}
add_action('wp_head', 'cartheme_theme_file');
/**
...
function ocdi_import_files() {
  return array(
    array(
      'import_file_name'           => 'Car Theme',
      'categories'                 => array('Business'),
      'import_file_url'            => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/cartheme/demo-content.xml',
      'import_widget_file_url'     => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/cartheme/widgets.wie',
      'import_customizer_file_url' => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/cartheme/customizer.dat',
      'import_preview_image_url'   => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/cartheme/screenshot.png',
      'import_notice'              => __( 'After you import this demo, you will have to setup the slider separately.', 'maximum' ),
      'preview_url'                => 'https://www.multipurposethemes.com/wordpressdemo/maximum/cartheme/',
    ),
  );
}
