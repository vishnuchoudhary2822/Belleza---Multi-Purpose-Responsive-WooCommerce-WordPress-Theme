...
<div class="row">
	<div class="col-md-12 col-sm-12">
		...
		<h2><?php _e( 'Oops! That page can&rsquo;t be found.', 'cartheme' ); ?></h2>
		</div>
	</div>
</div>
</div>
...
<div class="blog-text">
<?php get_search_form(); ?>
<?php _e( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'cartheme' ); ?></p>
</div>
</div>
<?php
	endwhile;
