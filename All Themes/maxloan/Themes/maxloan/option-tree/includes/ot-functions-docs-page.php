  ...
  function ot_type_creating_options() {
    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<p>' . __( 'Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, fashion, and step options and will only affect the Numeric Slider option type.', 'option-tree' ) . '</p>';
...
if ( ! function_exists( 'ot_type_examples' ) ) {
  ...
  if ( isset( measurement[0] ) && $measurement[1] ) {
    esc_html_e($measurement[0].$measurement[1]);
  } else {
    echo \'10px\';
  }
