...
function maximum_widgets_init()
{
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 5', 'maximum'),
        'id' => 'shop-footer-5',
        'description' => esc_html__('Appears in the footer area', 'maximum'),
        'before_widget' => '',
        'after_widget' => '',
    ...
    register_sidebar(array(
        'name' => esc_html__('Footer 6', 'maximum'),
        'id' => 'shop-footer-6',
        'description' => esc_html__('Appears in the footer area', 'maximum'),
        'before_widget' => '',
        'after_widget' => '',
...
function maximum_scripts()
{
    ...
    wp_enqueue_style('maximum-stylesheet', get_template_directory_uri() . '/css/maximum-style.css');
     ...
     wp_enqueue_style('OpenSans-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i');

    wp_enqueue_style('Montserrat-fonts', 'https://fonts.googleapis.com/css?family=Montserrat:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i');
    
    wp_enqueue_style('https://fonts.googleapis.com/css?family=Raleway');
...
function ocdi_import_files() {
  return array(
    array(
      'import_file_name'           => 'Max Loan',
      'categories'                 => array('Business'),
      'import_file_url'            => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/loan/demo-content.xml',
      'import_widget_file_url'     => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/loan/widgets.wie',
      'import_customizer_file_url' => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/loan/customizer.dat',
      'import_preview_image_url'   => 'http://html-templates.multipurposethemes.com/wordpress/themes/data/loan/screenshot.png',
      'import_notice'              => __( 'After you import this demo, you will have to setup the slider separately.', 'maximum' ),
      'preview_url'                => 'https://www.multipurposethemes.com/wordpressdemo/maximum/loan/',
    ),
  );
}
