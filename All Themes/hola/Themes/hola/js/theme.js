...
//Project:	Hola - Responsive Multipurpose Corporate WordPress Theme
//Version:	1.0
//Last change:	10/01/2017 [fixed bug]
//Primary use:	Hola - Responsive Multipurpose Corporate WordPress Theme 
...
jQuery(document).click(function(e) {
    if (!jQuery(e.target).is('.blog-post')) {
